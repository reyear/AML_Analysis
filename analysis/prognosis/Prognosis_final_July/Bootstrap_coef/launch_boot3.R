...
prognosis_features <- list(cyto=cyto,eln_cyto=eln_cyto,eln_comp_cyto=eln_comp_cyto,eln_comp_age_cyto=eln_comp_age_cyto,eln_comp_gen_cyto=eln_comp_gen_cyto,eln_comp_cyto_clin=eln_comp_cyto_clin,
                          eln_comp_cyto_demo=eln_comp_cyto_demo,eln_comp_cyto_demo_without_age=eln_comp_cyto_demo_without_age,
                         eln_comp_age_gen_cyto=eln_comp_age_gen_cyto,eln_comp_gen_cyto_clin_demo=eln_comp_gen_cyto_clin_demo,eln_age_cyto=eln_age_cyto,eln_gen_cyto=eln_gen_cyto)
