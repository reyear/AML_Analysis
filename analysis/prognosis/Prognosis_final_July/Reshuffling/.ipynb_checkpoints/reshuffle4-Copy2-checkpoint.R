...
prognosis_features<-list(eln_age_cyto=eln_age_cyto,eln_gen_cyto=eln_gen_cyto,eln_cyto_clin=eln_cyto_clin,eln_cyto_demo=eln_cyto_demo,eln_cyto_demo_without_age=eln_cyto_demo_without_age,eln_age_gen_cyto=eln_age_gen_cyto,
                        comp_cyto=comp_cyto,comp_gen_cyto=comp_gen_cyto,comp_gen_cyto_clin_demo,gen_cyto=gen_cyto,gen_cyto_clin_demo=gen_cyto_clin_demo,cyto_age=cyto_age)
