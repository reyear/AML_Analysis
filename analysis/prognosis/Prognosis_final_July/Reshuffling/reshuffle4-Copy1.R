...
prognosis_features<-list(eln_comp_age_gen_demo=eln_comp_age_gen_demo,eln_comp_age_gen_demo_without_age=eln_comp_age_gen_demo_without_age,eln_comp_gen_cyto_clin_demo=eln_comp_gen_cyto_clin_demo,
                        cyto=cyto,eln_cyto=eln_cyto,eln_comp_cyto=eln_comp_cyto,eln_comp_age_cyto=eln_comp_age_cyto,eln_comp_gen_cyto=eln_comp_gen_cyto,eln_gen_cyto_clin_demo=eln_gen_cyto_clin_demo)
