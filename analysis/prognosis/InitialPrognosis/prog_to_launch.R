...
df_final <- read.table("prognosis_comp_elli.tsv",sep='\t',header=T)
...
prognosis_features<- list(all_features=all_features,clin_demo_comp=clin_demo_comp,clin_demo_cyto_gen_comp=clin_demo_cyto_gen_comp,comp=comp,cyto_comp=cyto_comp,cyto_gen_comp=cyto_gen_comp,
                         ...
                         clin_demo_comp_without_age=clin_demo_comp_without_age,clin_demo_cyto_gen_comp_without_age=clin_demo_cyto_gen_comp_without_age,eln_clin_demo_comp_without_age=eln_clin_demo_comp_without_age,
                         demo_cyto=demo_cyto)
