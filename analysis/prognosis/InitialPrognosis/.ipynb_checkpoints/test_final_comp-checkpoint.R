...
prognosis_features<- list(all_features=all_features,clin_demo_cyto_gen_comp=clin_demo_cyto_gen_comp,eln_clin_demo_cyto_gen=eln_clin_demo_cyto_gen,clin_demo_cyto_gen=clin_demo_cyto_gen)
###--------------------------------------------------
