...
prognosis_features<- list(eln_comp_gen=eln_comp_gen,eln_comp=eln_comp,eln=eln,comp=comp,eln_comp_cyto=eln_comp_cyto,eln_comp_clin=eln_comp_clin,eln_comp_demo=eln_comp_demo,
